> [!IMPORTANT]
> Please see [rules/style/detached-metadata](https://docs.styra.com/regal/rules/style/detached-metadata) on the Styra documentation website for the canonical representation of this page.
